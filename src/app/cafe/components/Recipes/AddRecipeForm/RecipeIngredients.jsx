...
export function RecipeIngredients({ 
  ...
  //     : (ingredient.quantityGross / 1000) * ((product.price) || 0);
  // };
  ...
  switch (ingredient.unit) {
    case 'шт':
      return ingredient.quantity * (price / (product.quantity || 1));
    
    case 'г':
      return (ingredient.quantityGross) * (product.price / product.quantity);
  ...
  switch (ingredient.unit) {
    ...
    case 'г':
    case 'мл':
      return ingredient.quantityNet; // уже в граммах/миллилитрах
    
    case 'кг':
    case 'л':
      return ingredient.quantityNet * 1000; // переводим в граммы/миллилитры
